...
class TestDSTAccuracy(unittest.TestCase):
    ...
    def test_us_spring_forward_36min_before(self):
        ...
        next_dst_change, dst_offset_change = get_next_dst_transition(ZoneInfo('America/New_York'), test_time)
        ...
        self.assertEqual(dst_offset_change, 3600, "Should be +1 hour")
    ...
    def test_europe_spring_forward(self):
        ...
        next_dst_change, dst_offset_change = get_next_dst_transition(ZoneInfo('Europe/London'), test_time)
    ...
    def test_australia_fall_back(self):
        ...
        next_dst_change, dst_offset_change = get_next_dst_transition(ZoneInfo('Australia/Sydney'), test_time)
    ...
    def test_no_dst_timezone(self):
        ...
        next_dst_change, dst_offset_change = get_next_dst_transition(ZoneInfo('America/Phoenix'), test_time)
